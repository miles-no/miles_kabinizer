    ...
    <div className="flex flex-col gap-8 p-4">
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-2 items-center">
          <button className="btn btn-accent rounded-full text-sm font-extrabold">
            Button
          </button>
          <button className="btn btn-primary rounded-full text-sm font-extrabold">
            Button
          </button>
          <button className="btn btn-outline rounded-full text-sm font-extrabold">
            Button
          </button>
          <div className="tooltip" data-tip="Disabled">
            <button className="btn btn-disabled rounded-full text-sm font-extrabold">
              Button
            </button>
          </div>
          <p>
      ...
      <div className="btm-nav">
        <button className="bg-primary rounded-box flex flex-col items-center w-20 h-10">
          <svg
            width="27"
            height="26"
            viewBox="0 0 27 26"
          ...
          <span className="btm-nav-label text-primary-content">
            Hyttetrekning
          </span>
        </button>
        <button className="bg-primary rounded-box flex flex-col items-center w-20 h-10">
          ...
          <span className="btm-nav-label text-primary-content">Om hytten</span>
        </button>
        <button className="bg-primary rounded-box flex flex-col items-center w-20 h-10">
          <svg
            width="27"
