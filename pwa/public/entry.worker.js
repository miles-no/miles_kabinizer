...
const assets = [
  ...
  "/icons/Cabin.svg",
  "/icons/Check.svg",
  "/icons/Chevron Outline.svg",
  "/icons/Chevron.svg",
  "/icons/Close.svg",
  "/icons/Dots.svg",
  "/icons/Edit.svg",
  "/icons/Happy Face.svg",
  "/icons/Info.svg",
  "/icons/Key.svg",
  "/icons/Ticket Dots.svg",
  "/icons/User.svg",
  "/richer-install-assets/richer-install-screenshot-narrow.png",
  "/richer-install-assets/richer-install-screenshot-wide.png",
  "/maskable_icon/icon.iconset/Icon\r",
  "/maskable_icon/icon.iconset/icon_128x128.png",
  "/maskable_icon/icon.iconset/icon_128x128@2x.png",
  "/maskable_icon/icon.iconset/icon_16x16.png",
  "/maskable_icon/icon.iconset/icon_16x16@2x.png",
  "/maskable_icon/icon.iconset/icon_256x256.png",
  "/maskable_icon/icon.iconset/icon_256x256@2x.png",
  "/maskable_icon/icon.iconset/icon_32x32.png",
  "/maskable_icon/icon.iconset/icon_32x32@2x.png",
  "/maskable_icon/icon.iconset/icon_512x512.png",
  "/maskable_icon/icon.iconset/icon_512x512@2x.png"
];
const routes = {
  "root": {
    id: "root",
  ...
  "routes/draws.$draw.status": {
    id: "routes/draws.$draw.status",
    parentId: "root",
    path: "draws/:draw/status",
    index: void 0,
    caseSensitive: void 0,
    hasLoader: false,
    hasAction: false,
  ...
  "routes/draws.$id.edit": {
    id: "routes/draws.$id.edit",
    parentId: "routes/draws.$id",
    path: "edit",
    index: void 0,
    caseSensitive: void 0,
    hasLoader: true,
